...
#import "VTUIColorLabelButton.h"

@interface VTUIColorLabelButton(Private) 
- (void) resetColorLabels: (NSArray*) colors; 
- (void) resetTrackingRects;
@end

@implementation VTUIColorLabelButton
+ (void)initialize 
{ 
...
- (void) bootstrapView {
  ...
  NSArray* colors = [NSArray arrayWithObjects: 
    ...
    nil];
		...
		[mColorLabels setCellClass: [VTUIColorLabelButtonCell class]]; 
...
- (NSArray*) colorLabels {
	...
	VTUIColorLabelButtonCell*	cell			= nil; 
...
- (void) setSelectedColorLabel: (NSColor*) color {
  ...
  mColorLabelColor = color;

  if ((mColorLabelColor == nil) && (mDisplaysClearButton)) {
...
- (void) mouseEntered: (NSEvent*) event {
	...
	VTUIColorLabelButtonCell*	trackedCell		= (VTUIColorLabelButtonCell*)[mColorLabels cellWithTag: trackingTag]; 
...
#pragma mark -
@implementation VTUIColorLabelButton(Private) 
...
- (void) resetColorLabels: (NSArray*) colors {
	...
	if (mDisplaysClearButton) {
		VTUIColorLabelButtonCell* cell = [[mColorLabels cells] objectAtIndex: 0]; 
	...
	while (color = [colorIter nextObject]) {
		VTUIColorLabelButtonCell* cell = [[mColorLabels cells] objectAtIndex: columnIter]; 
		
		[cell setLabelType: VTUIColorLabelType]; 
		[cell setColor: color]; 
		[cell setTarget: self]; 
